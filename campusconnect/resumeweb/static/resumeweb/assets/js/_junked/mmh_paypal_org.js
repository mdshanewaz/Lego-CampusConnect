...
function show_payment_processing_status() {
    let ptst = document.getElementById("failed_payment_processing_status");
    ptst.removeAttribute("hidden");    
}


// "Payment Gateway loading failed" status
// *****************************************************************************
function showPaymentGatewayLoadingError() {
...
function showFailedPaymentProcessingStatus() {
    let ptst = document.getElementById("failed_payment_status_msg");
    ptst.removeAttribute("hidden");    
}
...
if (isPaypalDefined) {
    ...
    paypal.Buttons({
        ...
        onApprove: function(data, actions) {
            return fetch(magicUrl_vpaypal_capture+data.orderID, {
                ...
                console.log("Output of orderData >>>"+orderData);
                ...
                show_payment_processing_status();
  ...
  showPaymentGatewayLoadingError();
}
